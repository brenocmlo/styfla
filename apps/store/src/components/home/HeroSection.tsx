...
import { ShieldCheck, Zap, Truck, Flame, ArrowRight } from 'lucide-react';
import { SHIPPING_POLICY } from '@/lib/policies';

export function HeroSection() {
  return (
    <section className="relative py-24 px-6 border-b border-white/10 bg-gradient-to-b from-zinc-950 to-[#000000]">
      <div className="max-w-5xl mx-auto text-center space-y-7">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-black border border-white/20 text-[11px] font-mono font-bold tracking-widest text-zinc-300 uppercase">
        ...
        <p className="max-w-xl mx-auto text-zinc-400 text-sm sm:text-base leading-relaxed font-bold uppercase tracking-[0.15em]">
