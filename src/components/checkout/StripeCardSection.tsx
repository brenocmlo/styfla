...
export interface StripeCardFieldsProps {
...
export function StripeRealCardForm({
  cardHolderName,
  setCardHolderName,
  installments,
  setInstallments,
 ...
 */
export function StripeDemoCardForm({
  cardHolderName,
  setCardHolderName,
  installments,
  setInstallments,
...
export function StripeCardSection(props: StripeCardFieldsProps) {
